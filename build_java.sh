...
SRC_DIR="$BUILD_DIR/java/src-third-party-nav"
...
# Keep main-legacy-backup sources byte-for-byte readable and apply only Luka's
# two generic third-party navigation compatibility fixes to a disposable copy.
...
echo "Compiling $FILE_COUNT files (target 1.2, legacy + third-party nav compat)..."
